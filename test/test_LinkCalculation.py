...
class TestLinkCalculation(unittest.TestCase):
    ...
    def test_link_margin(self):
        link_margin = np.array([28.89428732, 27.3106624 , 25.97172661, 24.81188767, 23.78883722, 22.87368741, 22.04583371, 21.29006249, 20.59482036, 19.9511267 , 19.35186223, 18.79128776, 18.26470898, 17.76823731, 17.29861539])
